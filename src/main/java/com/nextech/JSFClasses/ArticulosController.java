package com.nextech.JSFClasses;

import com.nextech.entities.Articulos;
import com.nextech.JSFClasses.util.JsfUtil;
import com.nextech.JSFClasses.util.JsfUtil.PersistAction;
import com.nextech.Bean.ArticulosFacade;
...
@Named("articulosController")
@SessionScoped
public class ArticulosController implements Serializable {

    @EJB
    private com.nextech.Bean.ArticulosFacade ejbFacade;
    ...
    public Articulos getArticulos(java.lang.Integer id) {
    ...
    public static class ArticulosControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            return controller.getArticulos(getKey(value));
        }
